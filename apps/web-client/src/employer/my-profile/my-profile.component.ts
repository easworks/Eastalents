...
@Component({
  ...
  standalone: true,
  imports: [ExperienceSkillLayoutComponent,EducationPopupComponent, CertificationPopupComponent, JobReferenceLayoutComponent, UpdateCoreSkillPopupComponent, EducationCertificateLayoutComponent, CommonModule],
