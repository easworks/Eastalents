...
export const TALENT_SIGNUP_REASON_OPTIONS = [
...
export type TalentSignupReason = typeof TALENT_SIGNUP_REASON_OPTIONS[number];
...
export interface TalentProfile {
  ...
  personalDetails: {
    ...
    signupReason: TalentSignupReason | null;
    contact: {
      email: string;
      phone: {
        mobile: string | null;
