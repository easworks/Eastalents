...
@Component({
  ...
  styleUrls: ['./talent-quiz-question.component.css'],
})
export class TalentQuizQuestionComponent implements OnInit {
  ...
  loadQuiz(quizName: string) {
    ...
    this.httpService.get('questions/getLatestQuestions').subscribe(
  ...
  isAnswered(question: Question) {
    return question.optionsWithAnswers.find((x) => x.attempt)
      ? 'Answered'
      : 'Not Answered';
  }

  isCorrect(question: Question) {
    return question.optionsWithAnswers.every((x) => x.attempt === x.answer)
      ? 'correct'
      : 'wrong';
  }
  ...
  onSubmit() {
    ...
    this.httpService.post('questions/giveTest', this.quiz).subscribe(
      (response: ApiResponse<any>) => {
